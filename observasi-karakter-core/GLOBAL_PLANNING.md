...
- **Response**:
  ```json
  {
    ...
    "present_result_prompt": "Tampilkan 'default_talents' SEBAGAI VISUAL. Jika platform Anda mendukung Mermaid.js, buat diagram Bagan Pohon. Jika mendukung Artifacts/Canvas/Code Blocks, render visual yang kaya. Jika tidak, gunakan tabel Markdown yang indah. Jelaskan ini adalah estimasi awal.",
    "next_prompt_hint": "Setelah menampilkan bakat, beritahu pengguna bahwa untuk mematangkan hasil ini, kita perlu memverifikasi 18 sifat tersebut. Minta mereka memberikan skor (1=Sangat Tidak Setuju, 4=Sangat Setuju) untuk ke-18 pernyataan di 'verification_statements'. Setelah mereka menjawab, panggil `GET /api/v1/flow/step3?s={session_id}&v={18_skor_dipisah_koma}`."
  }
  ```
