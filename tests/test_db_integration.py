...
def test_db_save_obskarakter(client):
    # Call step 1
    response1 = client.get("/api/v1/flow/obskarakter/step1_wawancara")
    ...
    response2 = client.get(f"/api/v1/flow/obskarakter/step2?session_id={session_id}&scores={json.dumps(scores)}")
